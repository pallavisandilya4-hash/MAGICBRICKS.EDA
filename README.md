...
- Removed Columns: `show_id`, `description`  
- Dataset contains missing values which were handled during preprocessing  
...
- Some locations offer better value for money compared to others  
...
## 📎 Project File
- `magicbricksproject.ipynb` – Complete analysis notebook  
